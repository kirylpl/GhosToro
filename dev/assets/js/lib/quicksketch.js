...
(function() {
    ...
    Vector2D.clone = function(e) {
        var t = [];
        t[0] = e[0];
        t[1] = e[1];
        return t
    };
    Vector2D.fromValues = function(e, t) {
        var n = [];
        n[0] = e;
        n[1] = t;
        return n
    };
    Vector2D.copy = function(e, t) {
        e[0] = t[0];
        e[1] = t[1];
        return e
    };
    Vector2D.set = function(e, t, n) {
        e[0] = t;
        e[1] = n;
        return e
    };
    Vector2D.add = function(e, t, n) {
        e[0] = t[0] + n[0];
        e[1] = t[1] + n[1];
        return e
    };
    Vector2D.subtract = function(e, t, n) {
        e[0] = t[0] - n[0];
        e[1] = t[1] - n[1];
        return e
    };
    Vector2D.sub = Vector2D.subtract;
    Vector2D.multiply = function(e, t, n) {
        e[0] = t[0] * n[0];
        e[1] = t[1] * n[1];
        return e
    };
    Vector2D.mult = Vector2D.multiply;
    Vector2D.divide = function(e, t, n) {
        e[0] = t[0] / n[0];
        e[1] = t[1] / n[1];
        return e
    };
    Vector2D.div = Vector2D.divide;
    Vector2D.min = function(e, t, n) {
        e[0] = Math.min(t[0], n[0]);
        e[1] = Math.min(t[1], n[1]);
        return e
    };
    Vector2D.max = function(e, t, n) {
        e[0] = Math.max(t[0], n[0]);
        e[1] = Math.max(t[1], n[1]);
        return e
    };
    Vector2D.scale = function(e, t, n) {
        e[0] = t[0] * n;
        e[1] = t[1] * n;
        return e
    };
    Vector2D.scaleAndAdd = function(e, t, n, r) {
        e[0] = t[0] + n[0] * r;
        e[1] = t[1] + n[1] * r;
        return e
    };
    Vector2D.distance = function(e, t) {
        var n = t[0] - e[0];
        var r = t[1] - e[1];
        return Math.sqrt(n * n + r * r)
    };
    Vector2D.dist = Vector2D.distance;
    Vector2D.squaredDistance = function(e, t) {
        var n = t[0] - e[0];
        var r = t[1] - e[1];
        return n * n + r * r
    };
    Vector2D.sqrDist = Vector2D.squaredDistance;
    Vector2D.length = function(e) {
        var t = e[0];
        var n = e[1];
        return Math.sqrt(t * t + n * n)
    };
    Vector2D.len = Vector2D.length;
    Vector2D.squaredLength = function(e) {
        var t = e[0];
        var n = e[1];
        return t * t + n * n
    };
    Vector2D.sqrLen = Vector2D.squaredLength;
    Vector2D.negate = function(e, t) {
        e[0] = -t[0];
        e[1] = -t[1];
        return e
    };
    Vector2D.limit = function(e, t, n) {
        var r = t[0],
            i = t[1];
        var s = r * r + i * i;
        if (s > n * n && s > 0) {
            e[0] = r;
            e[1] = i;
            Vector2D.normalize(e, e);
            Vector2D.scale(e, e, n)
        }
        return e
    };
    Vector2D.normalize = function(e, t) {
        var n = t[0];
        var r = t[1];
        var i = n * n + r * r;
        if (i > 0) {
    ...
    Vector2D.dot = function(e, t) {
        return e[0] * t[0] + e[1] * t[1]
    };
    Vector2D.cross = function(e, t, n) {
        var r = t[0] * n[1] - t[1] * n[0];
        e[0] = e[1] = 0;
        e[2] = r;
        return e
    };
    Vector2D.lerp = function(e, t, n, r) {
        var i = t[0];
        var s = t[1];
        e[0] = i + r * (n[0] - i);
        e[1] = s + r * (n[1] - s);
    ...
    Vector2D.transformMat2 = function(e, t, n) {
        var r = t[0];
        var i = t[1];
        e[0] = n[0] * r + n[2] * i;
        e[1] = n[1] * r + n[3] * i;
    ...
    Vector2D.transformMat2d = function(e, t, n) {
        var r = t[0];
        var i = t[1];
        e[0] = n[0] * r + n[2] * i + n[4];
        e[1] = n[1] * r + n[3] * i + n[5];
    ...
    Vector2D.transformMat3 = function(e, t, n) {
        var r = t[0];
        var i = t[1];
        e[0] = n[0] * r + n[3] * i + n[6];
        e[1] = n[1] * r + n[4] * i + n[7];
    ...
    Vector2D.transformMat4 = function(e, t, n) {
        var r = t[0];
        var i = t[1];
    ...
    Vector2D.forEach = function() {
        var e = Vector2D.create();
